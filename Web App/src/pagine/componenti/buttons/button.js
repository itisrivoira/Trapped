...
import {Music, SoundBtn} from "../../../GlobalProvider";
...
import img_cuore from "./img/cuore.png";
import img_chiavetta from "./img/chiavetta.png";
...
export const BtnVita = () => {
  const [img, setImage] = useState(img_cuore);
...
export const BtnAiuto = () => {
  const [img, setImage] = useState(img_chiavetta);
